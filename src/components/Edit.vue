<template>
	<div class="app">
		...
		<div class="row justify-content-center">
          ...
          <br />
					<div class="form-group">
						<button class="btn btn-primary btn-block" @click="updateSubscription" style="width: 250px;">Update Subscription</button>
						<button class="btn btn-primary col-4" @click="cancelOperation" style="width: 250px;">Cancel</button>
					</div>
				</form>
			</div>
		</div>
